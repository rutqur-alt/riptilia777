...
export default function TraderHistorySales() {
  const { token } = useAuth();
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-4">
                  <div>
                    ...
                    {trade.status === "completed" && trade.trader_commission > 0 && (
                      <div className="text-xs text-[#F59E0B]">Комиссия: {trade.trader_commission} USDT</div>
                    )}
                  </div>
                </div>

...
export default function DepositPage() {
  ...
  useEffect(() => {
    if (trade && trade.id && (step === "payment" || step === "waiting" || step === "disputed")) {
      ...
      const interval = setInterval(() => fetchMessages(trade.id), 10000);
      return () => clearInterval(interval);
    }
  }, [trade, step]);
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 mb-4 overflow-hidden">
            ...
            <div className="p-2 border-t border-slate-100 flex gap-2">
              ...
              />
              <Button onClick={handleSendMessage} size="sm" className="bg-blue-600 hover:bg-blue-700 rounded-lg px-3" title="Отправить сообщение">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 mb-6 overflow-hidden">
            ...
            <div className="p-3 border-t border-slate-100 flex gap-2">
              ...
              />
              <Button onClick={handleSendMessage} className="bg-blue-600 hover:bg-blue-700 rounded-xl px-4" title="Отправить сообщение">
                <Send className="w-4 h-4" />
              </Button>
            </div>
          </div>

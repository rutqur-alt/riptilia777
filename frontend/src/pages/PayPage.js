...
export default function PayPage() {
  ...
  const handleOpenDispute = async () => {
    ...
    try {
      ...
      // Показываем ссылку на публичную страницу спора
      const disputeUrl = `${window.location.origin}/dispute/${trade.id}?buyer=true`;
      toast.success(
        <div>
          <p className="font-medium">Спор открыт!</p>
          <p className="text-sm text-zinc-400 mt-1">Сохраните ссылку для доступа к чату:</p>
          <button 
            onClick={() => {
              navigator.clipboard.writeText(disputeUrl);
              toast.success("Ссылка скопирована!");
            }}
            className="mt-2 text-xs bg-emerald-500/20 hover:bg-emerald-500/30 px-3 py-1 rounded-lg"
          >
            📋 Скопировать ссылку
          </button>
        </div>,
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-[#121212] border border-white/5 rounded-2xl mb-4">
            ...
            <div className="p-2 border-t border-white/5 flex gap-2">
              ...
              />
              <Button onClick={handleSendMessage} size="sm" className="bg-[#7C3AED] hover:bg-[#6D28D9] rounded-lg px-3" title="Отправить сообщение">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-[#121212] border border-white/5 rounded-2xl mb-6">
            ...
            <div className="p-3 border-t border-white/5 flex gap-2">
              ...
              />
              <Button onClick={handleSendMessage} className="bg-[#7C3AED] hover:bg-[#6D28D9] rounded-xl px-4" title="Отправить сообщение">

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5">
              <img src="/logo.png" alt="Reptiloid" className="w-9 h-9" />
            ...
            <div className="flex items-center gap-3">
              {isAuthenticated ? (
                <Link to={getDashboardLink()}>
                  <Button variant="ghost" className="text-white hover:bg-white/5 rounded-lg h-9 px-4" title="Перейти в личный кабинет">
                    Личный кабинет
                  </Button>
                </Link>
              ) : (
                <>
                  <Link to="/auth">
                    <Button variant="ghost" className="text-[#A1A1AA] hover:text-white hover:bg-white/5 rounded-lg h-9" title="Войти в аккаунт">
                      Войти
                    </Button>
                  </Link>
                  <Link to="/auth">
                    <Button className="bg-[#7C3AED] hover:bg-[#6D28D9] text-white rounded-lg h-9 px-4" title="Создать новый аккаунт">
                      Регистрация
                    </Button>
                  </Link>
                </>

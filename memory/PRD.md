...
- ✅ Комиссии теперь считаются в USDT (поле `merchant_commission`)
- ✅ Исправлен расчёт на дашборде и аналитике мерчанта
- ✅ Исправлен расчёт на admin overview (`/super-admin/overview`)
- ✅ Пересчитан `total_commission_paid` для всех мерчантов
- ✅ Результаты:
  - Admin: Комиссия заработана = 1.0533 USDT (13 сделок)
  - Merchant 222: Оплачено комиссий = 0.83 USDT (11 сделок)

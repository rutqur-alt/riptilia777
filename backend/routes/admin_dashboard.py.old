...
Handles admin analytics, dashboard stats, system settings, maintenance, accounting
"""
...
def _get_date_range(period: str, date_from: Optional[str] = None, date_to: Optional[str] = None):
...
async def get_accounting(
    ...
    """
    try:
        start_str, end_str = _get_date_range(period, date_from, date_to)

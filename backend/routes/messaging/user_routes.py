...
async def send_merchant_chat_message(data: SendMessageRequest, user: dict = Depends(get_current_user)):
...
async def send_shop_application_chat_message(data: SendMessageRequest, user: dict = Depends(get_current_user)):

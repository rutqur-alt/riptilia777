...
export default function TraderTradePage() {
  ...
  const initConversation = async () => {
    try {
      // Initialize unified conversation for this trade
      ...
      // Fallback - try to get existing conversation
      try {
      ...
      <header className="bg-[#121212] border-b border-white/5 px-4 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Сделка #{trade.id.slice(0, 8)}</h1>

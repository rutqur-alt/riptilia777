...
export function AdminMessagesToStaff() {
  ...
  useEffect(() => {
    if (activeTab === "direct" && selectedStaff) {
      ...
      const interval = setInterval(() => fetchDirectMessages(selectedStaff.id), 5000);
      return () => clearInterval(interval);
    }
  ...
  useEffect(() => {
    if (activeTab === "group_chats" && selectedGroupChat) {
      ...
      const interval = setInterval(() => fetchGroupChatMessages(selectedGroupChat.id), 5000);
      return () => clearInterval(interval);
    }
          ...
          {(activeTab === "general" || (activeTab === "direct" && selectedStaff) || (activeTab === "group_chats" && selectedGroupChat)) && (
            <div className="p-3 border-t border-white/5 bg-[#0A0A0A]">
              <div className="flex gap-2">
                ...
                <Button onClick={handleSend} disabled={sending || !newMessage.trim()} className="bg-[#7C3AED] hover:bg-[#6D28D9] h-10 px-4" data-testid="staff-send-btn">
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#121212] border border-white/10 rounded-2xl w-full max-w-lg">
            ...
            <div className="p-4 space-y-4">
              ...
              <Button onClick={createGroupChat} disabled={!newGroupChatName.trim()} className="w-full bg-[#10B981] hover:bg-[#059669] disabled:opacity-50">

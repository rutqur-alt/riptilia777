    ...
    <div className="space-y-4" data-testid="admin-overview">
        ...
        <div className="bg-[#121212] border border-white/5 rounded-xl p-4">
          ...
          <div className="space-y-2">
            {data?.trades?.disputed > 0 && (
              <Link to="/admin/p2p/disputes" className="flex items-center justify-between p-2 bg-[#EF4444]/10 rounded-lg hover:bg-[#EF4444]/20 transition-colors">
      ...
      <div className="bg-[#121212] border border-white/5 rounded-xl p-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link to="/admin/users" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs text-[#A1A1AA] hover:text-white transition-colors flex items-center gap-1.5">
            <Users className="w-3.5 h-3.5" /> Пользователи
          </Link>
          <Link to="/admin/p2p/disputes" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs text-[#A1A1AA] hover:text-white transition-colors flex items-center gap-1.5">
            <Scale className="w-3.5 h-3.5" /> Споры
          </Link>
          <Link to="/admin/market/withdrawals" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs text-[#A1A1AA] hover:text-white transition-colors flex items-center gap-1.5">
            <ArrowDownRight className="w-3.5 h-3.5" /> Выводы
          </Link>
          <Link to="/admin/settings/commissions" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs text-[#A1A1AA] hover:text-white transition-colors flex items-center gap-1.5">
            <Percent className="w-3.5 h-3.5" /> Комиссии
          </Link>
          <Link to="/admin/logs" className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs text-[#A1A1AA] hover:text-white transition-colors flex items-center gap-1.5">

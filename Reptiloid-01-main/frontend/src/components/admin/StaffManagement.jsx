  ...
  const handleCreate = async () => {
    ...
    try {
      await axios.post(
        ...
        { login: newStaff.login, password: newStaff.password, role: newStaff.role },
      ...
      {showCreate && (
        <div className="bg-[#121212] border border-white/10 rounded-xl p-4 space-y-3">
          ...
          <div className="flex gap-2">
            <Button onClick={handleCreate} size="sm" className="bg-[#10B981] hover:bg-[#059669] text-white text-xs h-7" title="Создать новое объявление">
              Создать
            </Button>
